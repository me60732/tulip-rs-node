...
pub fn instantaneoustrendline_indicator(
    ...
    js_pair(
        ...
        InstantaneoustrendlineState { inner },
    )
}
...
/// Run N assets through Instantaneous Trendline in a single SIMD pass (N = 2 | 4 | 8 | 16).
...
pub fn instantaneoustrendline_simd_by_assets(
    ...
    let states: Vec<InstantaneoustrendlineState> = states_inner
        .into_iter()
