...
pub fn avgprice_indicator(
    ...
    let (outputs, inner) =
        rust_avgprice::indicator(&input_arr, &option_arr, optional_outputs.as_deref())
            .map_err(map_error)?;
    js_pair(&env, vecs_to_float64arrays(outputs), AvgpriceState { inner })
}
...
#[napi]
pub fn avgprice_simd_by_assets(
    env: Env,
