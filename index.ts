...
export const chaikinmf = new Indicator("chaikinmf");
export const chandelierexit = new Indicator("chandelierexit");
...
export const donchianchannel = new Indicator("donchianchannel");
...
export const keltnerchannel = new Indicator("keltnerchannel");
...
export const smaenvelope = new Indicator("smaenvelope");
...
export const trvi = new Indicator("trvi");
...
export const vortex = new Indicator("vortex");
...
export const adaptivemsw = new Indicator("adaptivemsw");
export const ccfisher = new Indicator("ccfisher");
export const cybercycle = new Indicator("cybercycle");
export const highpass = new Indicator("highpass");
export const hilberttransform = new Indicator("hilberttransform");
export const homodynediscriminator = new Indicator("homodynediscriminator");
export const ichimoku = new Indicator("ichimoku");
export const instantaneoustrendline = new Indicator("instantaneoustrendline");
export const mama = new Indicator("mama");
export const roofingfilter = new Indicator("roofingfilter");
export const supersmoother = new Indicator("supersmoother");
export const supertrend = new Indicator("supertrend");
export const trendmode = new Indicator("trendmode");
export const vwap = new Indicator("vwap");
